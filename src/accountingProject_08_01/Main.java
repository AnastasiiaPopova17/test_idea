...
5. В программе должны также быть классы WageEmployee  и SalesManager  с полями id, name, secondName,
    ...
    public static void main(String[] args) {
        ...
        Employee salesManager1 = new SalesManager(7, "John", "Smith", 80, 0.5, 100000);
        Employee salesManager2 = new SalesManager(1, "Ann", "Black", 30, 0.5, 100000);
        Employee salesManager3 = new SalesManager(4, "Mary", "Kraft", 65, 0.3, 100000);

        Employee wageEmployee1 = new WageEmployee(2, "Jack", "Snow", 50, 20.5);
        ...
        Employee[] employees = {salesManager1, salesManager2, salesManager3,
                wageEmployee1, wageEmployee2, wageEmployee3};
